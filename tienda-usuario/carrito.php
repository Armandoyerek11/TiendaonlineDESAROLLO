...
if(isset($_GET['id']) && is_numeric($_GET['id'])){
    ...
    $resultado = $instrumentos->mostrarPorId($id);
    ...
    if(isset($_SESSION['carrito'])){ //SI EL CARRITO EXISTE
        ...
        if(array_key_exists($id,$_SESSION['carrito'])){
            actualizarInstrumento($id);
        }else{
            //  SI EL ACCESORIO NO EXISTE EN EL CARRITO
            agregarInstrumento($resultado, $id);
        }
    ...
    <div class="container" id="main">
            <table class="table table-bordered table-hover">
                  ...
                  <tbody>
                      ...
                      ?>
                        <tr>
                            <form action="actualizar_carrito.php" method="post">
                                <td><?php print $c ?></td>
                                <td><?php print $value['nombre_instrumento']  ?></td>
                                <td>
                                    <?php
                    ...
                    ?>
                        <tr>
                            <td colspan="7">No Hay Instrumentos En El Carrito </td>
                        </tr>
