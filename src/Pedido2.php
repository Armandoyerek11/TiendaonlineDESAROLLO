...
class Pedido2{
    ...
    public function registrarDetalle($_params){
        $sql = "INSERT INTO `detalle_pedidos2`(`pedido_id`, `evento_id`, `precio`, `cantidad`) 
        VALUES (:pedido_id,:evento_id,:precio,:cantidad)";
    ...
    public function mostrarDetallePorIdPedido2($id)
    {
        $sql = "SELECT
                ...
                INNER JOIN eventos ot ON ot.id= dp.evento_id
